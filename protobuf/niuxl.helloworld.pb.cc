...
void protobuf_AssignDesc_niuxl_2ehelloworld_2eproto() {
  protobuf_AddDesc_niuxl_2ehelloworld_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "niuxl.helloworld.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_niuxl_2ehelloworld_2eproto);
}
...
void protobuf_ShutdownFile_niuxl_2ehelloworld_2eproto() {
  delete helloworld::default_instance_;
  delete helloworld_reflection_;
}

void protobuf_AddDesc_niuxl_2ehelloworld_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\026niuxl.helloworld.proto\022\005niuxl\"2\n\nhello"
    "world\022\n\n\002id\030\001 \002(\005\022\013\n\003str\030\002 \002(\t\022\013\n\003opt\030\003 "
    "\001(\005", 83);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "niuxl.helloworld.proto", &protobuf_RegisterTypes);
  helloworld::default_instance_ = new helloworld();
  helloworld::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_niuxl_2ehelloworld_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_niuxl_2ehelloworld_2eproto {
  StaticDescriptorInitializer_niuxl_2ehelloworld_2eproto() {
    protobuf_AddDesc_niuxl_2ehelloworld_2eproto();
  }
} static_descriptor_initializer_niuxl_2ehelloworld_2eproto_;
...
const helloworld& helloworld::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_niuxl_2ehelloworld_2eproto();
